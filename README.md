...
<script>
alert("Hacked By Iman");
</script>
</head>
<body bgcolor=white>
<script type="text/javascript" src="http://htmlfreecodes.com/codes/rain.js"></script><br><div class="error">
<font color="red" size="7" face="Chicle">IMAN
<center>
</font><br>
<img style="width:50%" src="https://www.facebook.com/100003392409801/posts/4194314624024910/?app=fbl"></div>
<font color=black>
<br>
<b><font face="courier new" size='6'>hacked temux
...
<div style="text-shadow: 0px 0px 10px green;"><span style="color: white;"><font face="transformers"><b>Thanks To : <marquee scrollamount="5" direction="left" width="50%"><span style="color: red;"> <span style="color: red;">Firman Laradju<span style="color: red;"></b></marquee></font></div><script type="text/rocketscript">/*<![CDATA[*/new TypingText(document.getElementById("message"), 90, function(i){ var ar= new Array("_", " ", "_", " "); return "" +ar[i.length % ar.length]; });//Type out examples:TypingText.runAll();/*]]>*/</script>
